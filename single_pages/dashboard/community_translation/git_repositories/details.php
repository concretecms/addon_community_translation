...
if ($gitRepository->getID() !== null) {
    ?>
    <form id="comtra-delete" method="post" class="hide" action="<?= $view->action('deleteRepository', $gitRepository->getID()) ?>">
...
<form method="post" class="form-horizontal" action="<?= $view->action('save') ?>" onsubmit="if (this.already) return false; this.already = true">
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-sm-7">
                ...
                ?>
                <label><?= $form->radio('parsetags', '1', $parsetags === 1)?> <?= tc('Tags', 'none') ?></label><br />
                <label><?= $form->radio('parsetags', '2', $parsetags === 2)?> <?= tc('Tags', 'all') ?></label><br />
                <label><?= $form->radio('parsetags', '3', $parsetags === 3)?> <?= tc('Tags', 'filter') ?></label>
                ...
                <span class="comtra-parsetags-filter" style="visibility: hidden">
                    <label><?= $form->checkbox('parsetagsAnd2', '1', $ptx2 !== null) ?> <?= t('and')?></label>
    ...
    <div class="row" id="comtra-tag2verregex" style="display: none">
        <div class="form-group">
    ...
    <div class="ccm-dashboard-form-actions-wrapper">
        <div class="ccm-dashboard-form-actions">
            <a href="<?= URL::to('/dashboard/community_translation/git_repositories') ?>" class="btn btn-default pull-left"><?= t('Cancel') ?></a>
...
<div class="hide" id="comtra-devbranches-template">
    <div class="comtra-devbranches-pair" style="white-space: nowrap">
        <?= t('Branch') ?> <input type="text" name="branch[]" />
        &rArr;
        <?= t('Version') ?> <input type="text" name="version[]" />
...
$('input[name="parsetags"],#parsetagsAnd2').on('change', function() {
    ...
    $('#comtra-tag2verregex')[v === 1 ? 'hide' : 'show']('fast');
    if (v === 1) {
