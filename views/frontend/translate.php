...
/* @var Concrete\Package\CommunityTranslation\Controller\Frontend\Translate $controllers */
...
comtraOnlineEditorInitialize({
	...
	i18n: {
		glossaryTypes: <?php echo json_encode(GlossaryEntryType::getTypesInfo()); ?>,
		...
		pluralRuleNames: <?php echo json_encode([
