...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?= $exitURL ?>"><span class="d-none d-lg-block"><?= h($pageTitle) ?></span><span class="hidden-lg"><?= h($pageTitleShort) ?></span></a>
        </div>
...
$params = [
    ...
    'i18n' => [
        ...
        'Edit' => t('Edit'),
        'Approve' => t('Approve'),
        'Use_this_and_approve' => tc('Translation', 'Use this & Approve'),
        'Deny' => t('Deny'),
        'Ignore' => t('Ignore'),
