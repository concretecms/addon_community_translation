        ...
        <div class="float-right">
            ...
            switch ($access) {
                case Access::NOT_LOGGED_IN:
                    ?><a href="#" class="btn btn-secondary" onclick="<?= h('window.alert(' . json_encode(t('You must sign-in in order to join this translation group.')) . '); return false') ?>"><?= t('Join this team') ?></a><?php
                    break;
                case Access::NONE:
                    ?>
            ...
            ?>
            <a class="btn btn-secondary" href="<?= URL::to(Page::getCurrentPage()) ?>"><?= t('Back to Team list') ?></a>
        </div>
        <?php
        break;
}
